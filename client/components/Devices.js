...
export default class Devices extends React.Component {
  ...
  refresh() {
    axios.get('http://localhost:9002/api/devices', { headers: { authorization: this.state.authorization } })
    .then(res => {
  ...
  create(e) {
    ...
    axios.post('http://localhost:9002/api/devices', { serialNumber, product, category }, { headers: { authorization: this.state.authorization } })
    .then(() => {
      this.refresh();
    });
  }
